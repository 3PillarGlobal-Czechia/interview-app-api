...
public class CreateQuestionSetTests : E2ETestsBase, IClassFixture<MyWebApplicationFactory<Startup>>
{
    ...
    private async Task<StandardResponse<QuestionSetModel>> EndpointCall(CreateQuestionSetRequest request) => await PostAsync<CreateQuestionSetRequest, QuestionSetModel>(_url, request);
